...
--
-- Host: localhost    Database: thewallv2
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  KEY `fk_user_id_idx` (`user_level_id`),
  CONSTRAINT `fk_user_id` FOREIGN KEY (`user_level_id`) REFERENCES `user_levels` (`id`)
...
-- Dump completed on 2021-04-25 12:29:24
